...
def scalingCircuits(circuits, scales, copies):
    '''
    ...
    for i in scales: 
        ...
        for j in range(copies):
            copy = []
            for hammy_circ in circuits: 
                circ = GateInsertion(hammy_circ, i)
                copy.append(circ)
            scale_circs.append(copy)
        scaled_circuits.append(scale_circs)
    return scaled_circuits